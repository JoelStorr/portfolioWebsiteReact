  ...
  return (
    <>
      <div className="topBar">
        ...
        <ul>
          <li onClick={changeImpressum} className="clicker">
            Impressum
          </li>
          <li onClick={changeDatenschutz} className="clicker">
            Datenschutz
          </li>
        </ul>
      </div>
      ...
      <div
        className={showImpressum ? "impressum" : "impressum imperessumHider"}
      >
        <div>
          <h1>Impressum</h1>
        ...
        <button onClick={changeImpressum}>Close</button>
      </div>

      <div
        className={showDatenschutz ? "impressum" : "impressum imperessumHider"}
      >
        <div>
          ...
          <p>
            Joel Storr
            <br />
            Uthleder str. 26 28790 Schwanewede
          </p>
          <p>
            Telefon: 04209914691
            <br />
